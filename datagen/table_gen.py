...
code_list = """AALAND ISLANDS                                  AX      ALA     248
...
# setup country codes + weights

lines = code_list.split("\n")
codes_only = [x[len("UNITED STATES MINOR OUTLYING ISLANDS            "):len("UNITED STATES MINOR OUTLYING ISLANDS            ")+2] for x in lines]
weight_dict = {}
for x in codes_only: weight_dict[x] = 1.0
weight_dict["DE"] = 500.0
weight_dict["FR"] = 40.0
weight_dict["CH"] = 30.0
totals = sum(weight_dict.values())
for x in codes_only: weight_dict[x] /= totals
# print weight_dict
weights = [ weight_dict[w] for w in codes_only]



# print header
print "order_id|order_pos|order_line_value|customer_country"
print "INTEGER|INTEGER|INTEGER|STRING"
print "0_C|1_C|2_C|3_C"
print "==="
